...
reflect_obs({OldX,OldY},X,Y,[true,true,false,true]) -> 
    {X,Y+?OBS_REFLECT_RATE};

reflect_obs({OldX,OldY},X,Y,[true,false,true,true]) -> 
    {X-?OBS_REFLECT_RATE,Y};

reflect_obs({OldX,OldY},X,Y,[false,true,true,true]) ->
    {X+?OBS_REFLECT_RATE,Y};

reflect_obs({OldX,OldY},X,Y,[true,true,false,false]) -> 
...
reflect_obs({OldX,OldY},X,Y,[true,false,true,false]) -> 
    case random:uniform(2) of
        1 ->
            {X-?OBS_REFLECT_RATE,Y};
        2 -> 
...
reflect_obs({OldX,OldY},X,Y,[true,false,false,true]) -> 
    case random:uniform(2) of
        1 ->
            {X-?OBS_REFLECT_RATE,Y};
        2 -> 
...
reflect_obs({OldX,OldY},X,Y,[false,true,true,false]) -> 
    case random:uniform(2) of
        1 ->
            {X+?OBS_REFLECT_RATE,Y};
        2 -> 
...
reflect_obs({OldX,OldY},X,Y,[false,true,false,true]) -> 
    case random:uniform(2) of
        1 ->
            {X+?OBS_REFLECT_RATE,Y};
        2 -> 
...
reflect_obs({OldX,OldY},X,Y,[false,false,true,true]) ->
    case random:uniform(2) of
        1 ->
            {X+?OBS_REFLECT_RATE,Y};
        2 -> 
...
reflect_obs({OldX,OldY},X,Y,[true,false,false,false]) ->
    case random:uniform(3) of
        1 ->
            {X-?OBS_REFLECT_RATE,Y};
        2 -> 
...
reflect_obs({OldX,OldY},X,Y,[false,true,false,false]) ->
    case random:uniform(3) of
        1 ->
            {X+?OBS_REFLECT_RATE,Y};
        2 -> 
...
reflect_obs({OldX,OldY},X,Y,[false,false,true,false]) ->
    case random:uniform(3) of
        1 ->
            {X,Y-?OBS_REFLECT_RATE};
        2 -> 
...
reflect_obs({OldX,OldY},X,Y,[false,false,false,true]) ->
    case random:uniform(3) of
        1 ->
            {X,Y+?OBS_REFLECT_RATE};
        2 ->   
...
reflect_obs({OldX,OldY},X,Y,[false,false,false,false]) ->
