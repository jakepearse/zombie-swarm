...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{img/tile-viewer-human-msgs.png}
\caption{Human, Tile and Viewer Communication}
    \label{fig:Message passing between human, tile and viewer}
\end{figure}
